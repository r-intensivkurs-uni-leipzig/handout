...
df_regio$region <- ifelse(df_regio$Regio_Code < 11000, 
                          "Alte Bundesländer", "Neue Bundesländer")
df_regio$region <- as.factor(df_regio$region)

df_regio$durchschnittsalter_cat = cut_interval(
                                  df_regio$Durchschnittsalter,
                                  n = 3)
```
